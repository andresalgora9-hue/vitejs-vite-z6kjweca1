...
export default function Privacidad() {
  return (
    <div style={{ minHeight:"100vh", background:"#0A0A0F", color:"#F0F0FA", fontFamily:"'DM Sans',sans-serif", padding:"40px 24px", maxWidth:760, margin:"0 auto" }}>
      ...
      {[
        ["1. Responsable del Tratamiento","Oficioya, con domicilio en Sevilla, España. Contacto: admin@algoracompound.com · www.aficioya.com"],
        ["2. Datos que Recogemos","Nombre completo, email, teléfono, datos profesionales, fotografías de trabajos, datos de pago (gestionados íntegramente por Stripe; Oficioya no almacena datos de tarjeta), mensajes del chat, reseñas y valoraciones. También datos automáticos: IP, dispositivo, navegación y sesión."],
        ...
        ["5. Cesión a Terceros","Oficioya no vende datos. Puede compartirlos con: Stripe (pagos), Supabase (base de datos en la UE), Vercel (alojamiento) y autoridades públicas cuando la ley lo exija. Todos con contrato de encargado del tratamiento."],
        ...
        ["8. Menores","Oficioya no está dirigida a menores de 18 años."],

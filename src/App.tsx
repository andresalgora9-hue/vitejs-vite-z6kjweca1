...
const WORKERS = [
  {
    ...
    verified: true,
    price: 35,
    bio: '12 años de experiencia. Instalaciones, averías y domótica.',
    img: 'MH',
  ...
  },
  {
    ...
    verified: true,
    price: 30,
    bio: 'Especialista en tuberías, calderas y sistemas de calefacción.',
    img: 'LF',
    category: 'fontanero',
    jobs: 201,
  },
  {
    ...
    verified: true,
    price: 22,
    bio: 'Pintura interior y exterior. Acabados impecables garantizados.',
    img: 'RS',
    category: 'pintor',
    jobs: 145,
  },
  {
    ...
    verified: true,
    price: 28,
    bio: 'Reformas integrales, tabiques y revestimientos cerámicos.',
    img: 'AG',
    category: 'albanil',
    jobs: 98,
  },
  {
    ...
    verified: false,
    price: 32,
    bio: 'Muebles a medida, puertas y tarimas. Madera maciza.',
    img: 'JM',
    category: 'carpintero',
    jobs: 134,
  },
  {
    ...
    verified: true,
    price: 40,
    bio: 'Apertura de emergencia 24h. Instalación de cajas fuertes.',
    img: 'ER',
    category: 'cerrajero',
    jobs: 267,
  },
  {
    ...
    verified: true,
    price: 18,
    bio: 'Diseño y mantenimiento de jardines privados y comunidades.',
    img: 'CD',
    category: 'jardinero',
    jobs: 87,
  },
  {
    ...
    verified: true,
    price: 33,
    bio: 'Certificada en baja tensión. Placas solares y eficiencia energética.',
    img: 'IL',
    category: 'electricista',
    jobs: 220,
  },
...
function WorkerCard({ worker, onContact, index }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered
          ? '0 12px 32px rgba(139,94,60,0.15)'
    ...
    >
      ...
      >
        <Avatar
          initials={worker.img}
          size={52}
          color={worker.available ? C.earth : C.muted}
        />
      ...
      >
        ...
        <span style={{ fontSize: 12, color: C.muted }}>
          ({worker.reviews} reseñas)
        </span>
        <span style={{ fontSize: 11, color: C.muted, marginLeft: 'auto' }}>
          {worker.jobs} trabajos
        </span>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
          ...
          <span
            style={{
              fontSize: 11,
              color: worker.available ? C.success : C.muted,
              fontWeight: 600,
            }}
          >
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 20,
        border: `2px solid ${
          plan.popular ? C.accent : hovered ? plan.color : C.border
        }`,
        padding: '28px 24px',
        ...
        boxShadow: plan.popular
          ? `0 20px 48px rgba(232,80,10,0.2)`
          : hovered
    ...
    >
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <span
          style={{ fontSize: 13, color: plan.popular ? '#ffffff80' : C.muted }}
        >
          /mes
        </span>
      </div>
      ...
      >
        {plan.features.map((f) => (
          ...
          >
            <span style={{ color: plan.color, fontSize: 14, marginTop: 1 }}>
              ✓
            </span>
            <span
              style={{
                fontSize: 13,
                color: plan.popular ? '#ffffffCC' : C.muted,
                lineHeight: 1.4,
              }}
            >
              {f}
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: C.earth, fontWeight: 600, fontSize: 14 }}>
        ...
        >
          ...
          >
            💡 Para contactar a {worker.name.split(' ')[0]}
          </p>
          <p style={{ fontSize: 13, color: C.ink }}>
            El profesional necesita una suscripción activa. Tú como cliente
            contactas gratis.
          </p>
        </div>
      ...
      >
        ...
        {tab === 'buscar' && (
          <>
            ...
            >
              ...
              >
                <span style={{ animation: 'pulse 2s infinite', fontSize: 10 }}>
                  ●
                </span>
                <span
                  style={{ fontSize: 12, color: C.accent, fontWeight: 700 }}
                >
                  {WORKERS.filter((w) => w.available).length} profesionales
                  disponibles ahora
                </span>
              </div>
              <h1
              ...
              >
                Electricistas, fontaneros, carpinteros y más. Verificados, con
                reseñas reales y disponibilidad en tiempo real.
              </p>
              ...
              {CATEGORIES.map((cat) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 99,
                    border: `1.5px solid ${
                      category === cat.id ? C.earth : C.border
                    }`,
              ...
              {filtered.length === 0 && (
                ...
                >
                  ...
                  <p style={{ fontSize: 14, marginTop: 6 }}>
                    Prueba con otro oficio o ciudad
                  </p>
                </div>
              )}
            </div>
          ...
          <div style={{ padding: '48px 0', animation: 'fadeUp 0.4s ease' }}>
            ...
            >
              ...
              >
                Más clientes,
                <br />
                <span style={{ color: C.accent }}>más ingresos.</span>
              </h2>
              <p style={{ fontSize: 16, color: C.muted, lineHeight: 1.7 }}>
                Únete a los mejores profesionales de España. Tu perfil
                verificado llega a miles de clientes que buscan exactamente lo
                que tú ofreces.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Solo contactos reales. Sin spam, sin pérdida de tiempo.',
                },
                {
                  icon: '📊',
                  title: 'Estadísticas de perfil',
                  desc: 'Sabe cuántos clientes vieron tu perfil esta semana.',
                },
                {
                  icon: '⭐',
                  title: 'Sistema de reseñas',
                  desc: 'Las buenas valoraciones son tu mejor carta de presentación.',
                },
                {
                  icon: '🔔',
                  title: 'Notificaciones en tiempo real',
                  desc: 'Recibe avisos cuando alguien te contacta o te puntúa.',
                },
              ].map((f, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <p style={{ fontWeight: 700, color: C.ink, marginBottom: 6 }}>
                    {f.title}
                  </p>
        ...
        {tab === 'planes' && (
          <div style={{ padding: '48px 0', animation: 'fadeUp 0.4s ease' }}>
            ...
            >
              {PLANS.map((plan) => (
                <PlanCard
                  ...
                  onSelect={(p) =>
                    showToast(
                      `✓ Plan ${p.name} seleccionado — integrando pago...`
                    )
                  }
                />
              ))}
            ...
            >
              <p style={{ fontSize: 14, color: C.success, fontWeight: 700 }}>
                ✓ Pago 100% seguro · Factura incluida · Soporte en español
              </p>
            </div>
          </div>
        )}
          ...
          <div style={{ padding: '48px 0', animation: 'fadeUp 0.4s ease' }}>
            <div style={{ marginBottom: 28 }}>
              ...
              <p style={{ color: C.muted, fontSize: 14 }}>
                Proyecciones en tiempo real de OfficioYa
              </p>
            </div>
            ...
            >
              {[
                ...
                {
                  label: 'MRR estimado',
                  val: `${(WORKERS.length * 24.99).toFixed(0)}€`,
                  suffix: '/mes',
                  color: C.accent,
                },
                {
                  label: 'ARR estimado',
                  val: `${(WORKERS.length * 24.99 * 12).toFixed(0)}€`,
                  suffix: '/año',
                  color: C.success,
                },
                {
            ...
            >
              ...
              >
                📈 Proyección de crecimiento (Plan Pro · 24,99€/mes)
              </p>
              <div
              ...
              >
                {[
                  ...
                  >
                    ...
                    >
                      {row.mrr.toLocaleString()}€/m
                    </span>
                    <span style={{ width: 80, fontSize: 11, color: C.muted }}>
                      {row.pros} pros
                    </span>
                    <Badge color={row.mes === 'Mes 24' ? C.accent : C.earth}>
                      {row.label}
                    </Badge>
                  </div>
                ))}
            ...
            >
              ...
              >
                <p
                  style={{ fontWeight: 800, color: C.accent, marginBottom: 8 }}
                >
                  💡 Próximos pasos
                </p>
                {[
                  'Crear cuenta en Stripe para cobros',
                  'Publicar en grupos de Facebook de oficios',
                  'Contactar gremios locales (electricistas, fontaneros)',
                  'Lanzar en Madrid → Barcelona → Valencia',
                ].map((s, i) => (
                  <div
                    key={i}
              ...
              >
                <p
                  style={{ fontWeight: 800, color: C.success, marginBottom: 8 }}
                >
                  ✓ Ventaja competitiva
                </p>
                {[
                  ...
                  'Alta demanda de mano de obra cualificada',
                ].map((s, i) => (
                  <div
                    key={i}
                    style={{ display: 'flex', gap: 8, marginBottom: 6 }}

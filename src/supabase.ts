...
export interface UserRow {
  ...
  plan: Plan; bio?: string; price?: number; category?: string; trade?: string;
  zone?: string; rating: number; reviews: number; jobs: number;
  verified?: boolean; available?: boolean; whatsapp?: string;
  service_zones?: string[]; schedule?: string; response_time?: string;
  free_quote?: boolean; experience_years?: number; specialties?: string[];
  photos?: string[]; profile_views?: number; leads_count?: number;
...
export interface JobRow { id:string; worker_id:string; client_id:string; client_name:string; title:string; description?:string; status:"pending"|"in_progress"|"done"|"cancelled"; created_at:string; updated_at?:string; }
export interface ReviewRow { id:string; worker_id:string; client_id?:string; client_name:string; stars:number; text:string; photo_url?:string; approved?:boolean; reported?:boolean; created_at:string; }
